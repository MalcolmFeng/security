...
public class HttpUtils {
	 ...
	 * @return
	 */
	public static HttpResponse doPostWithTimeout(String apiUrl, String json) {
		CloseableHttpClient httpClient = HttpClients.createDefault();
		HttpPost httpPost = new HttpPost(apiUrl);
	 ...
	 * @return
	 */
	public static HttpResponse doDelete(String apiUrl) {
		CloseableHttpClient httpClient = HttpClients.createDefault();
	 ...
	 * @return
	 */
	public static HttpResponse doDeleteWithTimeout(String apiUrl) {
		CloseableHttpClient httpClient = HttpClients.createDefault();
		HttpDelete httpDelete = new HttpDelete(apiUrl);
		CloseableHttpResponse response = null;
		try {
